...
ov2640_ret_t ov2640_timer_irq_handler(Ov2640 *self);
ov2640_ret_t ov2640_dma_irq_handler(Ov2640 *self);

extern volatile uint8_t *process_buffer;
extern volatile size_t process_buffer_size;
